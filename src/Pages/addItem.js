    ...
    <div>
      ...
      <form onSubmit={handleSubmit}>
        ...
        <select id="category" name="category" value={category} onChange={(e) => setCategory(e.target.value)} required>
          ...
          <option value="aluminium value added">FRP</option>
          <option value="al val added">Extrusions</option>
          <option value="al val add">Foil & packaging</option>
          <option value="ml">metallurgical alumina</option>
        </select>
